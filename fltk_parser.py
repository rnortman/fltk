...
class Parser:
    ...
    def parse_grammar(self, pos: int) -> typing.Optional[fltk.fegen.pyrt.memo.ApplyResult[int, fltk_cst.Grammar]]:
    ...
    def parse_grammar__alt0(self, pos: int) -> typing.Optional[fltk.fegen.pyrt.memo.ApplyResult[int, fltk_cst.Grammar]]:
    ...
    def parse_rule(self, pos: int) -> typing.Optional[fltk.fegen.pyrt.memo.ApplyResult[int, fltk_cst.Rule]]:
        if alt0 := self.parse_rule__alt0(pos=pos):
            return alt0
        return None

    def apply__parse_rule(self, pos: int) -> typing.Optional[fltk.fegen.pyrt.memo.ApplyResult[int, fltk_cst.Rule]]:
        return self.packrat.apply(rule_callable=self.parse_rule, rule_id=1, rule_cache=self._cache__parse_rule, pos=pos)

    def parse_rule__alt0(self, pos: int) -> typing.Optional[fltk.fegen.pyrt.memo.ApplyResult[int, fltk_cst.Rule]]:
    ...
    def parse_rule__alt0__item0(
        self, pos: int
    ) -> typing.Optional[fltk.fegen.pyrt.memo.ApplyResult[int, fltk_cst.Identifier]]:
    ...
    def parse_rule__alt0__item2(
        self, pos: int
    ) -> typing.Optional[fltk.fegen.pyrt.memo.ApplyResult[int, fltk_cst.Alternatives]]:
    ...
    def parse_alternatives__alt0__item0(
        self, pos: int
    ) -> typing.Optional[fltk.fegen.pyrt.memo.ApplyResult[int, fltk_cst.Items]]:
    ...
    def parse_items(self, pos: int) -> typing.Optional[fltk.fegen.pyrt.memo.ApplyResult[int, fltk_cst.Items]]:
        if alt0 := self.parse_items__alt0(pos=pos):
            return alt0
        return None

    def apply__parse_items(self, pos: int) -> typing.Optional[fltk.fegen.pyrt.memo.ApplyResult[int, fltk_cst.Items]]:
        return self.packrat.apply(
            rule_callable=self.parse_items, rule_id=3, rule_cache=self._cache__parse_items, pos=pos
        )

    def parse_items__alt0(self, pos: int) -> typing.Optional[fltk.fegen.pyrt.memo.ApplyResult[int, fltk_cst.Items]]:
    ...
    def parse_items__alt0__item0(
        self, pos: int
    ) -> typing.Optional[fltk.fegen.pyrt.memo.ApplyResult[int, fltk_cst.Item]]:
    ...
    def parse_item(self, pos: int) -> typing.Optional[fltk.fegen.pyrt.memo.ApplyResult[int, fltk_cst.Item]]:
        if alt0 := self.parse_item__alt0(pos=pos):
            return alt0
        return None

    def apply__parse_item(self, pos: int) -> typing.Optional[fltk.fegen.pyrt.memo.ApplyResult[int, fltk_cst.Item]]:
        return self.packrat.apply(rule_callable=self.parse_item, rule_id=4, rule_cache=self._cache__parse_item, pos=pos)

    def parse_item__alt0(self, pos: int) -> typing.Optional[fltk.fegen.pyrt.memo.ApplyResult[int, fltk_cst.Item]]:
    ...
    def parse_item__alt0__item1(
        self, pos: int
    ) -> typing.Optional[fltk.fegen.pyrt.memo.ApplyResult[int, fltk_cst.Disposition]]:
        return self.apply__parse_disposition(pos=pos)

    def parse_item__alt0__item2(
        self, pos: int
    ) -> typing.Optional[fltk.fegen.pyrt.memo.ApplyResult[int, fltk_cst.Term]]:
        return self.apply__parse_term(pos=pos)

    def parse_item__alt0__item3(
        self, pos: int
    ) -> typing.Optional[fltk.fegen.pyrt.memo.ApplyResult[int, fltk_cst.Quantifier]]:
        return self.apply__parse_quantifier(pos=pos)

    def parse_term(self, pos: int) -> typing.Optional[fltk.fegen.pyrt.memo.ApplyResult[int, fltk_cst.Term]]:
    ...
    def apply__parse_term(self, pos: int) -> typing.Optional[fltk.fegen.pyrt.memo.ApplyResult[int, fltk_cst.Term]]:
        return self.packrat.apply(rule_callable=self.parse_term, rule_id=5, rule_cache=self._cache__parse_term, pos=pos)

    def parse_term__alt0(self, pos: int) -> typing.Optional[fltk.fegen.pyrt.memo.ApplyResult[int, fltk_cst.Term]]:
    ...
    def parse_term__alt1(self, pos: int) -> typing.Optional[fltk.fegen.pyrt.memo.ApplyResult[int, fltk_cst.Term]]:
        result: fltk_cst.Term = fltk_cst.Term(span=fltk.fegen.pyrt.terminalsrc.Span(start=pos, end=-1))
    ...
    def parse_term__alt1__item0(
        self, pos: int
    ) -> typing.Optional[fltk.fegen.pyrt.memo.ApplyResult[int, fltk_cst.Literal]]:
        return self.apply__parse_literal(pos=pos)

    def parse_term__alt2(self, pos: int) -> typing.Optional[fltk.fegen.pyrt.memo.ApplyResult[int, fltk_cst.Term]]:
        result: fltk_cst.Term = fltk_cst.Term(span=fltk.fegen.pyrt.terminalsrc.Span(start=pos, end=-1))
    ...
    def parse_term__alt2__item1(
        self, pos: int
    ) -> typing.Optional[fltk.fegen.pyrt.memo.ApplyResult[int, fltk_cst.RawString]]:
    ...
    def parse_term__alt3(self, pos: int) -> typing.Optional[fltk.fegen.pyrt.memo.ApplyResult[int, fltk_cst.Term]]:
        result: fltk_cst.Term = fltk_cst.Term(span=fltk.fegen.pyrt.terminalsrc.Span(start=pos, end=-1))
    ...
    def parse_quantifier(self, pos: int) -> typing.Optional[fltk.fegen.pyrt.memo.ApplyResult[int, fltk_cst.Quantifier]]:
    ...
    def parse_identifier(self, pos: int) -> typing.Optional[fltk.fegen.pyrt.memo.ApplyResult[int, fltk_cst.Identifier]]:
    ...
    def parse_raw_string(self, pos: int) -> typing.Optional[fltk.fegen.pyrt.memo.ApplyResult[int, fltk_cst.RawString]]:
    ...
    def parse_literal(self, pos: int) -> typing.Optional[fltk.fegen.pyrt.memo.ApplyResult[int, fltk_cst.Literal]]:
    ...
    def parse_literal__alt0(self, pos: int) -> typing.Optional[fltk.fegen.pyrt.memo.ApplyResult[int, fltk_cst.Literal]]:
