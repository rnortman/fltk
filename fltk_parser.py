...
class Parser:
    ...
    def parse_grammar__alt0(
        ...
        result: fltk_cst.Grammar = fltk_cst.Grammar(
    ...
    def parse_rule__alt0(
        ...
        result: fltk_cst.Rule = fltk_cst.Rule(
            span=fltk.fegen.pyrt.terminalsrc.Span(start=pos, end=-1)
        )
    ...
    def parse_alternatives__alt0(
        ...
        result: fltk_cst.Alternatives = fltk_cst.Alternatives(
            span=fltk.fegen.pyrt.terminalsrc.Span(start=pos, end=-1)
        )
    ...
    def parse_items__alt0(
        ...
        result: fltk_cst.Items = fltk_cst.Items(
            span=fltk.fegen.pyrt.terminalsrc.Span(start=pos, end=-1)
        )
    ...
    def parse_items__alt0__item1__alts__alt0__item0__alts(
        ...
        if alt1 := self.parse_items__alt0__item1__alts__alt0__item0__alts__alt1(
            ...
            return alt1
        if alt2 := self.parse_items__alt0__item1__alts__alt0__item0__alts__alt2(
            pos=pos
        ):
            return alt2
        return None
    ...
    def parse_items__alt0__item1__alts__alt0__item0__alts__alt2(
        ...
        if item0 := self.parse_items__alt0__item1__alts__alt0__item0__alts__alt2__item0(
            pos=pos
        ):
            pos = item0.pos
    ...
    def parse_item__alt0(
        ...
        result: fltk_cst.Item = fltk_cst.Item(
            span=fltk.fegen.pyrt.terminalsrc.Span(start=pos, end=-1)
        )
    ...
    def parse_term__alt0(
        ...
        result: fltk_cst.Term = fltk_cst.Term(
            span=fltk.fegen.pyrt.terminalsrc.Span(start=pos, end=-1)
        )
    ...
    def parse_disposition__alt0(
        ...
        result: fltk_cst.Disposition = fltk_cst.Disposition(
            span=fltk.fegen.pyrt.terminalsrc.Span(start=pos, end=-1)
        )
    ...
    def parse_quantifier__alt0(
        ...
        result: fltk_cst.Quantifier = fltk_cst.Quantifier(
            span=fltk.fegen.pyrt.terminalsrc.Span(start=pos, end=-1)
        )
    ...
    def parse_identifier__alt0(
        ...
        result: fltk_cst.Identifier = fltk_cst.Identifier(
            span=fltk.fegen.pyrt.terminalsrc.Span(start=pos, end=-1)
        )
    ...
    def parse_raw_string__alt0(
        ...
        result: fltk_cst.RawString = fltk_cst.RawString(
            span=fltk.fegen.pyrt.terminalsrc.Span(start=pos, end=-1)
        )
    ...
    def parse_literal__alt0(
        ...
        result: fltk_cst.Literal = fltk_cst.Literal(
            span=fltk.fegen.pyrt.terminalsrc.Span(start=pos, end=-1)
        )
