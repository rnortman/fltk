...
class TestPreamble:
    ...
    def test_preamble_at_start(self, poc_source: str) -> None:
        # Output starts with the generated-file header comment (no-source-name form).
        assert poc_source.startswith("//! Generated by fltk gen-rust-cst. Do not edit.\n")
    ...
    def test_header_with_source_name(self) -> None:
        ...
        gen = RustCstGenerator(_make_minimal_grammar(), source_name="path/to/grammar.fltkg")
        src = gen.generate()
        assert src.startswith("//! Generated by fltk gen-rust-cst from `path/to/grammar.fltkg`. Do not edit.\n")

    def test_header_without_source_name(self) -> None:
        """_gen_header without source_name emits the plain form (no 'from' clause)."""
        gen = RustCstGenerator(_make_minimal_grammar())
        src = gen.generate()
        assert src.startswith("//! Generated by fltk gen-rust-cst. Do not edit.\n")
        assert "from `" not in src.splitlines()[0]
...
# ---------------------------------------------------------------------------
# _escape_source_name unit tests
# ---------------------------------------------------------------------------


class TestEscapeSourceName:
    def test_plain_path_unchanged(self) -> None:
        assert _escape_source_name("path/to/grammar.fltkg") == "path/to/grammar.fltkg"

    def test_backslash_replaced_with_forward_slash(self) -> None:
        assert _escape_source_name("path\\to\\grammar.fltkg") == "path/to/grammar.fltkg"

    def test_backtick_replaced_with_apostrophe(self) -> None:
        assert _escape_source_name("gram`mar.fltkg") == "gram'mar.fltkg"

    def test_backslash_and_backtick_combined(self) -> None:
        assert _escape_source_name("C:\\gram`mar.fltkg") == "C:/gram'mar.fltkg"
...
class TestFegenGrammar:
    ...
    def test_preamble_in_fegen_source(self, fegen_source: str) -> None:
        ...
        assert fegen_source.startswith("//! Generated by fltk gen-rust-cst")
