...
impl Item {
    ...
    pub fn a(&self) -> Option<&Shared<ApplyResult>> {
        self.maybe_a()
    ...
    pub fn p(&self) -> Option<&Shared<Parser>> {
        self.maybe_p()
...
impl PyItem {
    ...
    fn a(&self, py: Python<'_>) -> pyo3::PyResult<Option<Py<pyo3::PyAny>>> {
        self.maybe_a(py)
    }

    fn p(&self, py: Python<'_>) -> pyo3::PyResult<Option<Py<pyo3::PyAny>>> {
        self.maybe_p(py)
    }
