...
class Trivia(typing.Protocol):
    ...
    span: fltk.fegen.pyrt.terminalsrc.Span | fltk._native.Span
    children: list[tuple[Label | None, BlockComment | LineComment | fltk.fegen.pyrt.span.Span]]

    def append(
        self, child: BlockComment | LineComment | fltk.fegen.pyrt.span.Span, label: Label | None = None
    ) -> None: ...
