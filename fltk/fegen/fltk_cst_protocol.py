...
class Grammar(typing.Protocol):
    ...
    def children(
        self,
    ) -> typing.Sequence[tuple[fltk.fegen.pyrt.label_protocol.LabelProtocol | None, Rule | Trivia]]: ...

    def append(
        self, child: Rule | Trivia, label: fltk.fegen.pyrt.label_protocol.LabelProtocol | None = None
    ) -> None: ...

    def extend(
        self,
        children: typing.Iterable[Rule | Trivia],
    ...
    def insert(
        self, index: int, child: Rule | Trivia, label: fltk.fegen.pyrt.label_protocol.LabelProtocol | None = None
    ) -> None: ...
...
class Items(typing.Protocol):
    ...
    def ws_allowed(self) -> typing.Sequence[fltk.fegen.pyrt.span_protocol.SpanProtocol]: ...

    def ws_required(self) -> typing.Sequence[fltk.fegen.pyrt.span_protocol.SpanProtocol]: ...
...
class Trivia(typing.Protocol):
    ...
    def block_comment(self) -> typing.Sequence[BlockComment]: ...
