...
from fltk.fegen.fltk_cst_protocol import NodeKind

if typing.TYPE_CHECKING:
    import fltk.fegen.fltk_cst_protocol as _cstp
...
class Grammar:
    ...
    def append(
        self, child: _cstp.Rule | _cstp.Trivia, label: fltk.fegen.pyrt.label_protocol.LabelProtocol | None = None
    ) -> None:
    ...
    def extend(
        self,
        children: typing.Iterable[_cstp.Rule | _cstp.Trivia],
    ...
    def _check_child_type_for_mutators(self, child: _cstp.Rule | _cstp.Trivia) -> None:
...
class Trivia:
    ...
    def append(
        self,
        child: _cstp.BlockComment | _cstp.LineComment | fltk.fegen.pyrt.span_protocol.SpanProtocol,
        label: fltk.fegen.pyrt.label_protocol.LabelProtocol | None = None,
    ) -> None:
        entry: typing.Any = (label, child)
        self.children.append(entry)
    ...
    def extend(
        self,
        children: typing.Iterable[_cstp.BlockComment | _cstp.LineComment | fltk.fegen.pyrt.span_protocol.SpanProtocol],
        label: fltk.fegen.pyrt.label_protocol.LabelProtocol | None = None,
    ) -> None:
        entries: typing.Any = ((label, child) for child in children)
        self.children.extend(entries)
    ...
    def _check_child_type_for_mutators(
        self, child: _cstp.BlockComment | _cstp.LineComment | fltk.fegen.pyrt.span_protocol.SpanProtocol
    ) -> None:
