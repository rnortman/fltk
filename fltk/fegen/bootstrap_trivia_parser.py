...
import fltk.fegen.bootstrap_cst
...
class Parser:
    ...
    def __init__(self, terminalsrc: fltk.fegen.pyrt.terminalsrc.TerminalSource) -> None:
        ...
        self._cache__parse_grammar: collections.abc.MutableMapping[
            int, fltk.fegen.pyrt.memo.MemoEntry[int, int, fltk.fegen.bootstrap_cst.Grammar]
        ] = {}
        self._cache__parse_rule: collections.abc.MutableMapping[
            int, fltk.fegen.pyrt.memo.MemoEntry[int, int, fltk.fegen.bootstrap_cst.Rule]
        ] = {}
        self._cache__parse_alternatives: collections.abc.MutableMapping[
            int, fltk.fegen.pyrt.memo.MemoEntry[int, int, fltk.fegen.bootstrap_cst.Alternatives]
        ] = {}
        self._cache__parse_items: collections.abc.MutableMapping[
            int, fltk.fegen.pyrt.memo.MemoEntry[int, int, fltk.fegen.bootstrap_cst.Items]
        ] = {}
        self._cache__parse_item: collections.abc.MutableMapping[
            int, fltk.fegen.pyrt.memo.MemoEntry[int, int, fltk.fegen.bootstrap_cst.Item]
        ] = {}
        self._cache__parse_term: collections.abc.MutableMapping[
            int, fltk.fegen.pyrt.memo.MemoEntry[int, int, fltk.fegen.bootstrap_cst.Term]
        ] = {}
        self._cache__parse_disposition: collections.abc.MutableMapping[
            int, fltk.fegen.pyrt.memo.MemoEntry[int, int, fltk.fegen.bootstrap_cst.Disposition]
        ] = {}
        self._cache__parse_quantifier: collections.abc.MutableMapping[
            int, fltk.fegen.pyrt.memo.MemoEntry[int, int, fltk.fegen.bootstrap_cst.Quantifier]
        ] = {}
        self._cache__parse_identifier: collections.abc.MutableMapping[
            int, fltk.fegen.pyrt.memo.MemoEntry[int, int, fltk.fegen.bootstrap_cst.Identifier]
        ] = {}
        self._cache__parse_raw_string: collections.abc.MutableMapping[
            int, fltk.fegen.pyrt.memo.MemoEntry[int, int, fltk.fegen.bootstrap_cst.RawString]
        ] = {}
        self._cache__parse_literal: collections.abc.MutableMapping[
            int, fltk.fegen.pyrt.memo.MemoEntry[int, int, fltk.fegen.bootstrap_cst.Literal]
        ] = {}
        self._cache__parse__trivia: collections.abc.MutableMapping[
            int, fltk.fegen.pyrt.memo.MemoEntry[int, int, fltk.fegen.bootstrap_cst.Trivia]
        ] = {}
        self._cache__parse_whitespace: collections.abc.MutableMapping[
            int, fltk.fegen.pyrt.memo.MemoEntry[int, int, fltk.fegen.bootstrap_cst.Whitespace]
        ] = {}
        self._cache__parse_line_comment: collections.abc.MutableMapping[
            int, fltk.fegen.pyrt.memo.MemoEntry[int, int, fltk.fegen.bootstrap_cst.LineComment]
        ] = {}
        self._cache__parse_block_comment: collections.abc.MutableMapping[
            int, fltk.fegen.pyrt.memo.MemoEntry[int, int, fltk.fegen.bootstrap_cst.BlockComment]
        ] = {}
    ...
    def parse_grammar(self, pos: int) -> fltk.fegen.pyrt.memo.ApplyResult[int, fltk.fegen.bootstrap_cst.Grammar] | None:
    ...
    def apply__parse_grammar(
        self, pos: int
    ) -> fltk.fegen.pyrt.memo.ApplyResult[int, fltk.fegen.bootstrap_cst.Grammar] | None:
    ...
    def parse_grammar__alt0(
        ...
        _span_start: int = pos
        result: fltk.fegen.bootstrap_cst.Grammar = fltk.fegen.bootstrap_cst.Grammar(
    ...
    def parse_rule(self, pos: int) -> fltk.fegen.pyrt.memo.ApplyResult[int, fltk.fegen.bootstrap_cst.Rule] | None:
    ...
    def apply__parse_rule(
        self, pos: int
    ) -> fltk.fegen.pyrt.memo.ApplyResult[int, fltk.fegen.bootstrap_cst.Rule] | None:
        return self.packrat.apply(rule_callable=self.parse_rule, rule_id=1, rule_cache=self._cache__parse_rule, pos=pos)

    def parse_rule__alt0(self, pos: int) -> fltk.fegen.pyrt.memo.ApplyResult[int, fltk.fegen.bootstrap_cst.Rule] | None:
        _span_start: int = pos
        result: fltk.fegen.bootstrap_cst.Rule = fltk.fegen.bootstrap_cst.Rule(
            span=fltk.fegen.pyrt.span.Span.with_source(pos, -1, self._source_text)
        )
    ...
    def parse_rule__alt0__item0(
        self, pos: int
    ) -> fltk.fegen.pyrt.memo.ApplyResult[int, fltk.fegen.bootstrap_cst.Identifier] | None:
    ...
    def parse_rule__alt0__item2(
        self, pos: int
    ) -> fltk.fegen.pyrt.memo.ApplyResult[int, fltk.fegen.bootstrap_cst.Alternatives] | None:
    ...
    def parse_alternatives__alt0(
        ...
        _span_start: int = pos
        result: fltk.fegen.bootstrap_cst.Alternatives = fltk.fegen.bootstrap_cst.Alternatives(
            span=fltk.fegen.pyrt.span.Span.with_source(pos, -1, self._source_text)
        )
    ...
    def parse_alternatives__alt0__item0(
        self, pos: int
    ) -> fltk.fegen.pyrt.memo.ApplyResult[int, fltk.fegen.bootstrap_cst.Items] | None:
    ...
    def parse_items(self, pos: int) -> fltk.fegen.pyrt.memo.ApplyResult[int, fltk.fegen.bootstrap_cst.Items] | None:
    ...
    def parse_items__alt0(
        ...
        _span_start: int = pos
        result: fltk.fegen.bootstrap_cst.Items = fltk.fegen.bootstrap_cst.Items(
            span=fltk.fegen.pyrt.span.Span.with_source(pos, -1, self._source_text)
        )
        ...
        if item2 := self.parse_items__alt0__item2(pos=pos):
            pos = item2.pos
            result.extend_children(other=item2.result)
        if ws_after__item2 := self.apply__parse__trivia(pos=pos):
            pos = ws_after__item2.pos
            result.append(child=ws_after__item2.result, label=None)
        if item3 := self.parse_items__alt0__item3(pos=pos):
            pos = item3.pos
    ...
    def parse_items__alt0__item0__alts(
        ...
        if alt0 := self.parse_items__alt0__item0__alts__alt0(pos=pos):
            return alt0
        if alt1 := self.parse_items__alt0__item0__alts__alt1(pos=pos):
            return alt1
        return None

    def parse_items__alt0__item0__alts__alt0(
        self, pos: int
    ) -> fltk.fegen.pyrt.memo.ApplyResult[int, fltk.fegen.bootstrap_cst.Items] | None:
        _span_start: int = pos
        result: fltk.fegen.bootstrap_cst.Items = fltk.fegen.bootstrap_cst.Items(
    ...
    def parse_items__alt0__item0(
        ...
        return self.parse_items__alt0__item0__alts(pos=pos)

    def parse_items__alt0__item1(
        self, pos: int
    ) -> fltk.fegen.pyrt.memo.ApplyResult[int, fltk.fegen.bootstrap_cst.Item] | None:
    ...
    def parse_items__alt0__item2__alts__alt0(
        ...
        if ws_after__item0 := self.apply__parse__trivia(pos=pos):
            pos = ws_after__item0.pos
            result.append(child=ws_after__item0.result, label=None)
        if item1 := self.parse_items__alt0__item2__alts__alt0__item1(pos=pos):
            pos = item1.pos
            result.append_item(child=item1.result)
        else:
            return None
    ...
    def parse_items__alt0__item2__alts__alt0__item0__alts(
        ...
        if alt0 := self.parse_items__alt0__item2__alts__alt0__item0__alts__alt0(pos=pos):
            return alt0
        if alt1 := self.parse_items__alt0__item2__alts__alt0__item0__alts__alt1(pos=pos):
            return alt1
        return None

    def parse_items__alt0__item2__alts__alt0__item0__alts__alt0(
        self, pos: int
    ) -> fltk.fegen.pyrt.memo.ApplyResult[int, fltk.fegen.bootstrap_cst.Items] | None:
        _span_start: int = pos
        result: fltk.fegen.bootstrap_cst.Items = fltk.fegen.bootstrap_cst.Items(
    ...
    def parse_items__alt0__item2__alts__alt0__item0(
        ...
        return self.parse_items__alt0__item2__alts__alt0__item0__alts(pos=pos)

    def parse_items__alt0__item2__alts__alt0__item1(
        self, pos: int
    ) -> fltk.fegen.pyrt.memo.ApplyResult[int, fltk.fegen.bootstrap_cst.Item] | None:
        return self.apply__parse_item(pos=pos)
    ...
    def parse_items__alt0__item3__alts(
        ...
        if alt0 := self.parse_items__alt0__item3__alts__alt0(pos=pos):
            return alt0
        if alt1 := self.parse_items__alt0__item3__alts__alt1(pos=pos):
            return alt1
        return None

    def parse_items__alt0__item3__alts__alt0(
        self, pos: int
    ) -> fltk.fegen.pyrt.memo.ApplyResult[int, fltk.fegen.bootstrap_cst.Items] | None:
        _span_start: int = pos
        result: fltk.fegen.bootstrap_cst.Items = fltk.fegen.bootstrap_cst.Items(
    ...
    def parse_items__alt0__item3(
        ...
        return self.parse_items__alt0__item3__alts(pos=pos)

    def parse_item(self, pos: int) -> fltk.fegen.pyrt.memo.ApplyResult[int, fltk.fegen.bootstrap_cst.Item] | None:
    ...
    def parse_item__alt0(self, pos: int) -> fltk.fegen.pyrt.memo.ApplyResult[int, fltk.fegen.bootstrap_cst.Item] | None:
        _span_start: int = pos
        result: fltk.fegen.bootstrap_cst.Item = fltk.fegen.bootstrap_cst.Item(
            span=fltk.fegen.pyrt.span.Span.with_source(pos, -1, self._source_text)
        )
    ...
    def parse_item__alt0__item1(
        self, pos: int
    ) -> fltk.fegen.pyrt.memo.ApplyResult[int, fltk.fegen.bootstrap_cst.Disposition] | None:
        return self.apply__parse_disposition(pos=pos)

    def parse_item__alt0__item2(
        self, pos: int
    ) -> fltk.fegen.pyrt.memo.ApplyResult[int, fltk.fegen.bootstrap_cst.Term] | None:
        return self.apply__parse_term(pos=pos)

    def parse_item__alt0__item3(
        self, pos: int
    ) -> fltk.fegen.pyrt.memo.ApplyResult[int, fltk.fegen.bootstrap_cst.Quantifier] | None:
        return self.apply__parse_quantifier(pos=pos)

    def parse_term(self, pos: int) -> fltk.fegen.pyrt.memo.ApplyResult[int, fltk.fegen.bootstrap_cst.Term] | None:
    ...
    def parse_term__alt0(self, pos: int) -> fltk.fegen.pyrt.memo.ApplyResult[int, fltk.fegen.bootstrap_cst.Term] | None:
        _span_start: int = pos
        result: fltk.fegen.bootstrap_cst.Term = fltk.fegen.bootstrap_cst.Term(
            span=fltk.fegen.pyrt.span.Span.with_source(pos, -1, self._source_text)
        )
    ...
    def parse_term__alt1(self, pos: int) -> fltk.fegen.pyrt.memo.ApplyResult[int, fltk.fegen.bootstrap_cst.Term] | None:
        _span_start: int = pos
        result: fltk.fegen.bootstrap_cst.Term = fltk.fegen.bootstrap_cst.Term(
            span=fltk.fegen.pyrt.span.Span.with_source(pos, -1, self._source_text)
        )
    ...
    def parse_term__alt1__item0(
        self, pos: int
    ) -> fltk.fegen.pyrt.memo.ApplyResult[int, fltk.fegen.bootstrap_cst.Literal] | None:
        return self.apply__parse_literal(pos=pos)

    def parse_term__alt2(self, pos: int) -> fltk.fegen.pyrt.memo.ApplyResult[int, fltk.fegen.bootstrap_cst.Term] | None:
        _span_start: int = pos
        result: fltk.fegen.bootstrap_cst.Term = fltk.fegen.bootstrap_cst.Term(
            span=fltk.fegen.pyrt.span.Span.with_source(pos, -1, self._source_text)
        )
    ...
    def parse_term__alt2__item1(
        self, pos: int
    ) -> fltk.fegen.pyrt.memo.ApplyResult[int, fltk.fegen.bootstrap_cst.RawString] | None:
    ...
    def parse_term__alt3(self, pos: int) -> fltk.fegen.pyrt.memo.ApplyResult[int, fltk.fegen.bootstrap_cst.Term] | None:
        _span_start: int = pos
        result: fltk.fegen.bootstrap_cst.Term = fltk.fegen.bootstrap_cst.Term(
            span=fltk.fegen.pyrt.span.Span.with_source(pos, -1, self._source_text)
        )
    ...
    def parse_disposition__alt0(
        ...
        _span_start: int = pos
        result: fltk.fegen.bootstrap_cst.Disposition = fltk.fegen.bootstrap_cst.Disposition(
            span=fltk.fegen.pyrt.span.Span.with_source(pos, -1, self._source_text)
        )
    ...
    def parse_quantifier__alt0(
        ...
        _span_start: int = pos
        result: fltk.fegen.bootstrap_cst.Quantifier = fltk.fegen.bootstrap_cst.Quantifier(
            span=fltk.fegen.pyrt.span.Span.with_source(pos, -1, self._source_text)
        )
    ...
    def parse_identifier__alt0(
        ...
        _span_start: int = pos
        result: fltk.fegen.bootstrap_cst.Identifier = fltk.fegen.bootstrap_cst.Identifier(
            span=fltk.fegen.pyrt.span.Span.with_source(pos, -1, self._source_text)
        )
    ...
    def parse_raw_string__alt0(
        ...
        _span_start: int = pos
        result: fltk.fegen.bootstrap_cst.RawString = fltk.fegen.bootstrap_cst.RawString(
            span=fltk.fegen.pyrt.span.Span.with_source(pos, -1, self._source_text)
        )
    ...
    def parse_literal(self, pos: int) -> fltk.fegen.pyrt.memo.ApplyResult[int, fltk.fegen.bootstrap_cst.Literal] | None:
    ...
    def parse_literal__alt0(
        ...
        _span_start: int = pos
        result: fltk.fegen.bootstrap_cst.Literal = fltk.fegen.bootstrap_cst.Literal(
            span=fltk.fegen.pyrt.span.Span.with_source(pos, -1, self._source_text)
        )
    ...
    def parse__trivia(self, pos: int) -> fltk.fegen.pyrt.memo.ApplyResult[int, fltk.fegen.bootstrap_cst.Trivia] | None:
        if alt0 := self.parse__trivia__alt0(pos=pos):
            return alt0
        if alt1 := self.parse__trivia__alt1(pos=pos):
            return alt1
        if alt2 := self.parse__trivia__alt2(pos=pos):
            return alt2
        return None

    def apply__parse__trivia(
        self, pos: int
    ) -> fltk.fegen.pyrt.memo.ApplyResult[int, fltk.fegen.bootstrap_cst.Trivia] | None:
        return self.packrat.apply(
    ...
    def parse__trivia__alt0(
        ...
        _span_start: int = pos
        result: fltk.fegen.bootstrap_cst.Trivia = fltk.fegen.bootstrap_cst.Trivia(
            span=fltk.fegen.pyrt.span.Span.with_source(pos, -1, self._source_text)
        )
    ...
    def parse__trivia__alt0__item0(
        self, pos: int
    ) -> fltk.fegen.pyrt.memo.ApplyResult[int, fltk.fegen.bootstrap_cst.Whitespace] | None:
        return self.apply__parse_whitespace(pos=pos)

    def parse__trivia__alt1(
        self, pos: int
    ) -> fltk.fegen.pyrt.memo.ApplyResult[int, fltk.fegen.bootstrap_cst.Trivia] | None:
        _span_start: int = pos
        result: fltk.fegen.bootstrap_cst.Trivia = fltk.fegen.bootstrap_cst.Trivia(
        ...
        if item0 := self.parse__trivia__alt1__item0(pos=pos):
            pos = item0.pos
    ...
    def parse__trivia__alt1__item0(
        self, pos: int
    ) -> fltk.fegen.pyrt.memo.ApplyResult[int, fltk.fegen.bootstrap_cst.LineComment] | None:
        return self.apply__parse_line_comment(pos=pos)

    def parse__trivia__alt2(
        self, pos: int
    ) -> fltk.fegen.pyrt.memo.ApplyResult[int, fltk.fegen.bootstrap_cst.Trivia] | None:
        _span_start: int = pos
        result: fltk.fegen.bootstrap_cst.Trivia = fltk.fegen.bootstrap_cst.Trivia(
        ...
        if item0 := self.parse__trivia__alt2__item0(pos=pos):
            pos = item0.pos
    ...
    def parse__trivia__alt2__item0(
        self, pos: int
    ) -> fltk.fegen.pyrt.memo.ApplyResult[int, fltk.fegen.bootstrap_cst.BlockComment] | None:
    ...
    def parse_whitespace__alt0(
        ...
        _span_start: int = pos
        result: fltk.fegen.bootstrap_cst.Whitespace = fltk.fegen.bootstrap_cst.Whitespace(
            span=fltk.fegen.pyrt.span.Span.with_source(pos, -1, self._source_text)
        )
    ...
    def parse_line_comment__alt0(
        ...
        _span_start: int = pos
        result: fltk.fegen.bootstrap_cst.LineComment = fltk.fegen.bootstrap_cst.LineComment(
            span=fltk.fegen.pyrt.span.Span.with_source(pos, -1, self._source_text)
        )
    ...
    def parse_block_comment__alt0(
        ...
        _span_start: int = pos
        result: fltk.fegen.bootstrap_cst.BlockComment = fltk.fegen.bootstrap_cst.BlockComment(
            span=fltk.fegen.pyrt.span.Span.with_source(pos, -1, self._source_text)
        )
