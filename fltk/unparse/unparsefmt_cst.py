...
class Formatter:
    ...
    children: list[tuple[typing.Optional[Label], typing.Union['Statement', 'Trivia']]] = dataclasses.field(default_factory=list)

    def append(self, child: typing.Union['Statement', 'Trivia'], label: typing.Optional[Label]=None) -> None:
        self.children.append((label, child))

    def extend(self, children: typing.Iterable[typing.Union['Statement', 'Trivia']], label: typing.Optional[Label]=None) -> None:
        self.children.extend(((label, child) for child in children))

    def child(self) -> tuple[typing.Optional[Label], typing.Union['Statement', 'Trivia']]:
...
class Statement:
    ...
    span: fltk.fegen.pyrt.terminalsrc.Span = fltk.fegen.pyrt.terminalsrc.UnknownSpan
    children: list[tuple[typing.Optional[Label], typing.Union['After', 'Before', 'Default', 'Group', 'Join', 'Nest', 'Omit', 'PreserveBlanks', 'Render', 'RuleConfig', 'TriviaPreserve']]] = dataclasses.field(default_factory=list)

    def append(self, child: typing.Union['After', 'Before', 'Default', 'Group', 'Join', 'Nest', 'Omit', 'PreserveBlanks', 'Render', 'RuleConfig', 'TriviaPreserve'], label: typing.Optional[Label]=None) -> None:
        self.children.append((label, child))

    def extend(self, children: typing.Iterable[typing.Union['After', 'Before', 'Default', 'Group', 'Join', 'Nest', 'Omit', 'PreserveBlanks', 'Render', 'RuleConfig', 'TriviaPreserve']], label: typing.Optional[Label]=None) -> None:
        self.children.extend(((label, child) for child in children))

    def child(self) -> tuple[typing.Optional[Label], typing.Union['After', 'Before', 'Default', 'Group', 'Join', 'Nest', 'Omit', 'PreserveBlanks', 'Render', 'RuleConfig', 'TriviaPreserve']]:
        if (n := len(self.children)) != 1:
            msg = f'Expected one child but have {n}'
            raise ValueError(msg)
        return self.children[0]
    ...
    def children_preserve_blanks(self) -> typing.Iterator['PreserveBlanks']:
        return (typing.cast('PreserveBlanks', child) for label, child in self.children if label == Statement.Label.PRESERVE_BLANKS)
    ...
    def children_rule_config(self) -> typing.Iterator['RuleConfig']:
        return (typing.cast('RuleConfig', child) for label, child in self.children if label == Statement.Label.RULE_CONFIG)
    ...
    def children_trivia_preserve(self) -> typing.Iterator['TriviaPreserve']:
        return (typing.cast('TriviaPreserve', child) for label, child in self.children if label == Statement.Label.TRIVIA_PRESERVE)
...
class Default:
    ...
    span: fltk.fegen.pyrt.terminalsrc.Span = fltk.fegen.pyrt.terminalsrc.UnknownSpan
    children: list[tuple[typing.Optional[Label], typing.Union['Spacing', 'Trivia', 'fltk.fegen.pyrt.terminalsrc.Span']]] = dataclasses.field(default_factory=list)

    def append(self, child: typing.Union['Spacing', 'Trivia', 'fltk.fegen.pyrt.terminalsrc.Span'], label: typing.Optional[Label]=None) -> None:
        self.children.append((label, child))

    def extend(self, children: typing.Iterable[typing.Union['Spacing', 'Trivia', 'fltk.fegen.pyrt.terminalsrc.Span']], label: typing.Optional[Label]=None) -> None:
        self.children.extend(((label, child) for child in children))

    def child(self) -> tuple[typing.Optional[Label], typing.Union['Spacing', 'Trivia', 'fltk.fegen.pyrt.terminalsrc.Span']]:
        if (n := len(self.children)) != 1:
            msg = f'Expected one child but have {n}'
            raise ValueError(msg)
        return self.children[0]
    ...
    def children_ws_allowed(self) -> typing.Iterator['fltk.fegen.pyrt.terminalsrc.Span']:
        return (typing.cast('fltk.fegen.pyrt.terminalsrc.Span', child) for label, child in self.children if label == Default.Label.WS_ALLOWED)
    ...
    def children_ws_required(self) -> typing.Iterator['fltk.fegen.pyrt.terminalsrc.Span']:
        return (typing.cast('fltk.fegen.pyrt.terminalsrc.Span', child) for label, child in self.children if label == Default.Label.WS_REQUIRED)
...
class RuleConfig:
    ...
    span: fltk.fegen.pyrt.terminalsrc.Span = fltk.fegen.pyrt.terminalsrc.UnknownSpan
    children: list[tuple[typing.Optional[Label], typing.Union['Identifier', 'RuleStatement', 'Trivia']]] = dataclasses.field(default_factory=list)

    def append(self, child: typing.Union['Identifier', 'RuleStatement', 'Trivia'], label: typing.Optional[Label]=None) -> None:
        self.children.append((label, child))

    def extend(self, children: typing.Iterable[typing.Union['Identifier', 'RuleStatement', 'Trivia']], label: typing.Optional[Label]=None) -> None:
        self.children.extend(((label, child) for child in children))

    def child(self) -> tuple[typing.Optional[Label], typing.Union['Identifier', 'RuleStatement', 'Trivia']]:
        if (n := len(self.children)) != 1:
            msg = f'Expected one child but have {n}'
            raise ValueError(msg)
        return self.children[0]
    ...
    def children_rule_name(self) -> typing.Iterator['Identifier']:
        return (typing.cast('Identifier', child) for label, child in self.children if label == RuleConfig.Label.RULE_NAME)
    ...
    def children_rule_statement(self) -> typing.Iterator['RuleStatement']:
        return (typing.cast('RuleStatement', child) for label, child in self.children if label == RuleConfig.Label.RULE_STATEMENT)
...
class RuleStatement:
    ...
    class Label(enum.Enum):
        ...
        RENDER = enum.auto()
    span: fltk.fegen.pyrt.terminalsrc.Span = fltk.fegen.pyrt.terminalsrc.UnknownSpan
    children: list[tuple[typing.Optional[Label], typing.Union['After', 'Before', 'Default', 'Group', 'Join', 'Nest', 'Omit', 'PreserveBlanks', 'Render']]] = dataclasses.field(default_factory=list)

    def append(self, child: typing.Union['After', 'Before', 'Default', 'Group', 'Join', 'Nest', 'Omit', 'PreserveBlanks', 'Render'], label: typing.Optional[Label]=None) -> None:
        self.children.append((label, child))

    def extend(self, children: typing.Iterable[typing.Union['After', 'Before', 'Default', 'Group', 'Join', 'Nest', 'Omit', 'PreserveBlanks', 'Render']], label: typing.Optional[Label]=None) -> None:
        self.children.extend(((label, child) for child in children))

    def child(self) -> tuple[typing.Optional[Label], typing.Union['After', 'Before', 'Default', 'Group', 'Join', 'Nest', 'Omit', 'PreserveBlanks', 'Render']]:
        if (n := len(self.children)) != 1:
            msg = f'Expected one child but have {n}'
            raise ValueError(msg)
        return self.children[0]
    ...
    def children_preserve_blanks(self) -> typing.Iterator['PreserveBlanks']:
        return (typing.cast('PreserveBlanks', child) for label, child in self.children if label == RuleStatement.Label.PRESERVE_BLANKS)
...
class Group:
    ...
    class Label(enum.Enum):
        ...
        TO_SPEC = enum.auto()
    span: fltk.fegen.pyrt.terminalsrc.Span = fltk.fegen.pyrt.terminalsrc.UnknownSpan
    children: list[tuple[typing.Optional[Label], typing.Union['FromSpec', 'ToSpec', 'Trivia']]] = dataclasses.field(default_factory=list)

    def append(self, child: typing.Union['FromSpec', 'ToSpec', 'Trivia'], label: typing.Optional[Label]=None) -> None:
        self.children.append((label, child))

    def extend(self, children: typing.Iterable[typing.Union['FromSpec', 'ToSpec', 'Trivia']], label: typing.Optional[Label]=None) -> None:
        self.children.extend(((label, child) for child in children))

    def child(self) -> tuple[typing.Optional[Label], typing.Union['FromSpec', 'ToSpec', 'Trivia']]:
        if (n := len(self.children)) != 1:
            msg = f'Expected one child but have {n}'
            raise ValueError(msg)
        return self.children[0]
...
class Nest:
    ...
    class Label(enum.Enum):
        ...
        TO_SPEC = enum.auto()
    span: fltk.fegen.pyrt.terminalsrc.Span = fltk.fegen.pyrt.terminalsrc.UnknownSpan
    children: list[tuple[typing.Optional[Label], typing.Union['FromSpec', 'Integer', 'ToSpec', 'Trivia']]] = dataclasses.field(default_factory=list)

    def append(self, child: typing.Union['FromSpec', 'Integer', 'ToSpec', 'Trivia'], label: typing.Optional[Label]=None) -> None:
        self.children.append((label, child))

    def extend(self, children: typing.Iterable[typing.Union['FromSpec', 'Integer', 'ToSpec', 'Trivia']], label: typing.Optional[Label]=None) -> None:
        self.children.extend(((label, child) for child in children))

    def child(self) -> tuple[typing.Optional[Label], typing.Union['FromSpec', 'Integer', 'ToSpec', 'Trivia']]:
        if (n := len(self.children)) != 1:
            msg = f'Expected one child but have {n}'
            raise ValueError(msg)
        return self.children[0]
...
class Join:
    ...
    class Label(enum.Enum):
        ...
        TO_SPEC = enum.auto()
    span: fltk.fegen.pyrt.terminalsrc.Span = fltk.fegen.pyrt.terminalsrc.UnknownSpan
    children: list[tuple[typing.Optional[Label], typing.Union['DocLiteral', 'FromSpec', 'ToSpec', 'Trivia']]] = dataclasses.field(default_factory=list)

    def append(self, child: typing.Union['DocLiteral', 'FromSpec', 'ToSpec', 'Trivia'], label: typing.Optional[Label]=None) -> None:
        self.children.append((label, child))

    def extend(self, children: typing.Iterable[typing.Union['DocLiteral', 'FromSpec', 'ToSpec', 'Trivia']], label: typing.Optional[Label]=None) -> None:
        self.children.extend(((label, child) for child in children))

    def child(self) -> tuple[typing.Optional[Label], typing.Union['DocLiteral', 'FromSpec', 'ToSpec', 'Trivia']]:
        if (n := len(self.children)) != 1:
            msg = f'Expected one child but have {n}'
            raise ValueError(msg)
        return self.children[0]
...
class FromSpec:
    ...
    span: fltk.fegen.pyrt.terminalsrc.Span = fltk.fegen.pyrt.terminalsrc.UnknownSpan
    children: list[tuple[typing.Optional[Label], typing.Union['Anchor', 'Trivia', 'fltk.fegen.pyrt.terminalsrc.Span']]] = dataclasses.field(default_factory=list)

    def append(self, child: typing.Union['Anchor', 'Trivia', 'fltk.fegen.pyrt.terminalsrc.Span'], label: typing.Optional[Label]=None) -> None:
        self.children.append((label, child))

    def extend(self, children: typing.Iterable[typing.Union['Anchor', 'Trivia', 'fltk.fegen.pyrt.terminalsrc.Span']], label: typing.Optional[Label]=None) -> None:
        self.children.extend(((label, child) for child in children))

    def child(self) -> tuple[typing.Optional[Label], typing.Union['Anchor', 'Trivia', 'fltk.fegen.pyrt.terminalsrc.Span']]:
        if (n := len(self.children)) != 1:
            msg = f'Expected one child but have {n}'
            raise ValueError(msg)
        return self.children[0]
    ...
    def children_after(self) -> typing.Iterator['fltk.fegen.pyrt.terminalsrc.Span']:
        return (typing.cast('fltk.fegen.pyrt.terminalsrc.Span', child) for label, child in self.children if label == FromSpec.Label.AFTER)
...
class ToSpec:
    ...
    def children_before(self) -> typing.Iterator['fltk.fegen.pyrt.terminalsrc.Span']:
        return (typing.cast('fltk.fegen.pyrt.terminalsrc.Span', child) for label, child in self.children if label == ToSpec.Label.BEFORE)
...
class Anchor:
    ...
    class Label(enum.Enum):
        ...
        LITERAL = enum.auto()
    span: fltk.fegen.pyrt.terminalsrc.Span = fltk.fegen.pyrt.terminalsrc.UnknownSpan
    children: list[tuple[typing.Optional[Label], typing.Union['Identifier', 'Literal']]] = dataclasses.field(default_factory=list)

    def append(self, child: typing.Union['Identifier', 'Literal'], label: typing.Optional[Label]=None) -> None:
        self.children.append((label, child))

    def extend(self, children: typing.Iterable[typing.Union['Identifier', 'Literal']], label: typing.Optional[Label]=None) -> None:
        self.children.extend(((label, child) for child in children))

    def child(self) -> tuple[typing.Optional[Label], typing.Union['Identifier', 'Literal']]:
        if (n := len(self.children)) != 1:
            msg = f'Expected one child but have {n}'
            raise ValueError(msg)
        return self.children[0]
...
class After:
    ...
    span: fltk.fegen.pyrt.terminalsrc.Span = fltk.fegen.pyrt.terminalsrc.UnknownSpan
    children: list[tuple[typing.Optional[Label], typing.Union['Anchor', 'PositionSpecStatement', 'Trivia']]] = dataclasses.field(default_factory=list)

    def append(self, child: typing.Union['Anchor', 'PositionSpecStatement', 'Trivia'], label: typing.Optional[Label]=None) -> None:
        self.children.append((label, child))

    def extend(self, children: typing.Iterable[typing.Union['Anchor', 'PositionSpecStatement', 'Trivia']], label: typing.Optional[Label]=None) -> None:
        self.children.extend(((label, child) for child in children))

    def child(self) -> tuple[typing.Optional[Label], typing.Union['Anchor', 'PositionSpecStatement', 'Trivia']]:
        if (n := len(self.children)) != 1:
            msg = f'Expected one child but have {n}'
            raise ValueError(msg)
        return self.children[0]
    ...
    def children_position_spec_statement(self) -> typing.Iterator['PositionSpecStatement']:
        return (typing.cast('PositionSpecStatement', child) for label, child in self.children if label == After.Label.POSITION_SPEC_STATEMENT)
...
class Before:
    ...
    def children_position_spec_statement(self) -> typing.Iterator['PositionSpecStatement']:
        return (typing.cast('PositionSpecStatement', child) for label, child in self.children if label == Before.Label.POSITION_SPEC_STATEMENT)
...
class Omit:
    ...
    class Label(enum.Enum):
        ANCHOR = enum.auto()
    span: fltk.fegen.pyrt.terminalsrc.Span = fltk.fegen.pyrt.terminalsrc.UnknownSpan
    children: list[tuple[typing.Optional[Label], typing.Union['Anchor', 'Trivia']]] = dataclasses.field(default_factory=list)

    def append(self, child: typing.Union['Anchor', 'Trivia'], label: typing.Optional[Label]=None) -> None:
        self.children.append((label, child))

    def extend(self, children: typing.Iterable[typing.Union['Anchor', 'Trivia']], label: typing.Optional[Label]=None) -> None:
        self.children.extend(((label, child) for child in children))

    def child(self) -> tuple[typing.Optional[Label], typing.Union['Anchor', 'Trivia']]:
        if (n := len(self.children)) != 1:
            msg = f'Expected one child but have {n}'
            raise ValueError(msg)
        return self.children[0]
...
class Render:
    ...
    class Label(enum.Enum):
        ...
        SPACING = enum.auto()
    span: fltk.fegen.pyrt.terminalsrc.Span = fltk.fegen.pyrt.terminalsrc.UnknownSpan
    children: list[tuple[typing.Optional[Label], typing.Union['Anchor', 'Spacing', 'Trivia']]] = dataclasses.field(default_factory=list)

    def append(self, child: typing.Union['Anchor', 'Spacing', 'Trivia'], label: typing.Optional[Label]=None) -> None:
        self.children.append((label, child))

    def extend(self, children: typing.Iterable[typing.Union['Anchor', 'Spacing', 'Trivia']], label: typing.Optional[Label]=None) -> None:
        self.children.extend(((label, child) for child in children))

    def child(self) -> tuple[typing.Optional[Label], typing.Union['Anchor', 'Spacing', 'Trivia']]:
        if (n := len(self.children)) != 1:
            msg = f'Expected one child but have {n}'
            raise ValueError(msg)
        return self.children[0]
...
class PositionSpecStatement:
    ...
    class Label(enum.Enum):
        ...
        SPACING = enum.auto()
    span: fltk.fegen.pyrt.terminalsrc.Span = fltk.fegen.pyrt.terminalsrc.UnknownSpan
    children: list[tuple[typing.Optional[Label], typing.Union['PreserveBlanks', 'Spacing', 'Trivia']]] = dataclasses.field(default_factory=list)

    def append(self, child: typing.Union['PreserveBlanks', 'Spacing', 'Trivia'], label: typing.Optional[Label]=None) -> None:
        self.children.append((label, child))

    def extend(self, children: typing.Iterable[typing.Union['PreserveBlanks', 'Spacing', 'Trivia']], label: typing.Optional[Label]=None) -> None:
        self.children.extend(((label, child) for child in children))

    def child(self) -> tuple[typing.Optional[Label], typing.Union['PreserveBlanks', 'Spacing', 'Trivia']]:
        if (n := len(self.children)) != 1:
            msg = f'Expected one child but have {n}'
            raise ValueError(msg)
        return self.children[0]
    ...
    def children_preserve_blanks(self) -> typing.Iterator['PreserveBlanks']:
        return (typing.cast('PreserveBlanks', child) for label, child in self.children if label == PositionSpecStatement.Label.PRESERVE_BLANKS)
    ...
    def children_spacing(self) -> typing.Iterator['Spacing']:
        return (typing.cast('Spacing', child) for label, child in self.children if label == PositionSpecStatement.Label.SPACING)
...
class Spacing:
    ...
    class Label(enum.Enum):
        ...
        SOFT = enum.auto()
    span: fltk.fegen.pyrt.terminalsrc.Span = fltk.fegen.pyrt.terminalsrc.UnknownSpan
    children: list[tuple[typing.Optional[Label], typing.Union['Integer', 'Trivia', 'fltk.fegen.pyrt.terminalsrc.Span']]] = dataclasses.field(default_factory=list)

    def append(self, child: typing.Union['Integer', 'Trivia', 'fltk.fegen.pyrt.terminalsrc.Span'], label: typing.Optional[Label]=None) -> None:
        self.children.append((label, child))

    def extend(self, children: typing.Iterable[typing.Union['Integer', 'Trivia', 'fltk.fegen.pyrt.terminalsrc.Span']], label: typing.Optional[Label]=None) -> None:
        self.children.extend(((label, child) for child in children))

    def child(self) -> tuple[typing.Optional[Label], typing.Union['Integer', 'Trivia', 'fltk.fegen.pyrt.terminalsrc.Span']]:
        if (n := len(self.children)) != 1:
            msg = f'Expected one child but have {n}'
            raise ValueError(msg)
        return self.children[0]
    ...
    def children_blank(self) -> typing.Iterator['fltk.fegen.pyrt.terminalsrc.Span']:
        return (typing.cast('fltk.fegen.pyrt.terminalsrc.Span', child) for label, child in self.children if label == Spacing.Label.BLANK)
    ...
    def children_bsp(self) -> typing.Iterator['fltk.fegen.pyrt.terminalsrc.Span']:
        return (typing.cast('fltk.fegen.pyrt.terminalsrc.Span', child) for label, child in self.children if label == Spacing.Label.BSP)
    ...
    def children_hard(self) -> typing.Iterator['fltk.fegen.pyrt.terminalsrc.Span']:
        return (typing.cast('fltk.fegen.pyrt.terminalsrc.Span', child) for label, child in self.children if label == Spacing.Label.HARD)
    ...
    def children_nbsp(self) -> typing.Iterator['fltk.fegen.pyrt.terminalsrc.Span']:
        return (typing.cast('fltk.fegen.pyrt.terminalsrc.Span', child) for label, child in self.children if label == Spacing.Label.NBSP)
    ...
    def children_nil(self) -> typing.Iterator['fltk.fegen.pyrt.terminalsrc.Span']:
        return (typing.cast('fltk.fegen.pyrt.terminalsrc.Span', child) for label, child in self.children if label == Spacing.Label.NIL)
    ...
    def children_soft(self) -> typing.Iterator['fltk.fegen.pyrt.terminalsrc.Span']:
        return (typing.cast('fltk.fegen.pyrt.terminalsrc.Span', child) for label, child in self.children if label == Spacing.Label.SOFT)
...
class DocLiteral:
    ...
    span: fltk.fegen.pyrt.terminalsrc.Span = fltk.fegen.pyrt.terminalsrc.UnknownSpan
    children: list[tuple[typing.Optional[Label], typing.Union['CompoundLiteral', 'ConcatLiteral', 'JoinLiteral', 'Spacing', 'TextLiteral']]] = dataclasses.field(default_factory=list)

    def append(self, child: typing.Union['CompoundLiteral', 'ConcatLiteral', 'JoinLiteral', 'Spacing', 'TextLiteral'], label: typing.Optional[Label]=None) -> None:
        self.children.append((label, child))

    def extend(self, children: typing.Iterable[typing.Union['CompoundLiteral', 'ConcatLiteral', 'JoinLiteral', 'Spacing', 'TextLiteral']], label: typing.Optional[Label]=None) -> None:
        self.children.extend(((label, child) for child in children))

    def child(self) -> tuple[typing.Optional[Label], typing.Union['CompoundLiteral', 'ConcatLiteral', 'JoinLiteral', 'Spacing', 'TextLiteral']]:
        if (n := len(self.children)) != 1:
            msg = f'Expected one child but have {n}'
            raise ValueError(msg)
        return self.children[0]
    ...
    def children_compound_literal(self) -> typing.Iterator['CompoundLiteral']:
        return (typing.cast('CompoundLiteral', child) for label, child in self.children if label == DocLiteral.Label.COMPOUND_LITERAL)
    ...
    def children_concat_literal(self) -> typing.Iterator['ConcatLiteral']:
        return (typing.cast('ConcatLiteral', child) for label, child in self.children if label == DocLiteral.Label.CONCAT_LITERAL)
    ...
    def children_join_literal(self) -> typing.Iterator['JoinLiteral']:
        return (typing.cast('JoinLiteral', child) for label, child in self.children if label == DocLiteral.Label.JOIN_LITERAL)
    ...
    def children_text_literal(self) -> typing.Iterator['TextLiteral']:
        return (typing.cast('TextLiteral', child) for label, child in self.children if label == DocLiteral.Label.TEXT_LITERAL)
...
class TextLiteral:
    ...
    class Label(enum.Enum):
        TEXT = enum.auto()
    span: fltk.fegen.pyrt.terminalsrc.Span = fltk.fegen.pyrt.terminalsrc.UnknownSpan
    children: list[tuple[typing.Optional[Label], typing.Union['Literal', 'Trivia']]] = dataclasses.field(default_factory=list)

    def append(self, child: typing.Union['Literal', 'Trivia'], label: typing.Optional[Label]=None) -> None:
        self.children.append((label, child))

    def extend(self, children: typing.Iterable[typing.Union['Literal', 'Trivia']], label: typing.Optional[Label]=None) -> None:
        self.children.extend(((label, child) for child in children))

    def child(self) -> tuple[typing.Optional[Label], typing.Union['Literal', 'Trivia']]:
        if (n := len(self.children)) != 1:
            msg = f'Expected one child but have {n}'
            raise ValueError(msg)
        return self.children[0]
...
class ConcatLiteral:
    ...
    span: fltk.fegen.pyrt.terminalsrc.Span = fltk.fegen.pyrt.terminalsrc.UnknownSpan
    children: list[tuple[typing.Optional[Label], typing.Union['DocListLiteral', 'Trivia']]] = dataclasses.field(default_factory=list)

    def append(self, child: typing.Union['DocListLiteral', 'Trivia'], label: typing.Optional[Label]=None) -> None:
        self.children.append((label, child))

    def extend(self, children: typing.Iterable[typing.Union['DocListLiteral', 'Trivia']], label: typing.Optional[Label]=None) -> None:
        self.children.extend(((label, child) for child in children))

    def child(self) -> tuple[typing.Optional[Label], typing.Union['DocListLiteral', 'Trivia']]:
        if (n := len(self.children)) != 1:
            msg = f'Expected one child but have {n}'
            raise ValueError(msg)
        return self.children[0]
    ...
    def children_doc_list_literal(self) -> typing.Iterator['DocListLiteral']:
        return (typing.cast('DocListLiteral', child) for label, child in self.children if label == ConcatLiteral.Label.DOC_LIST_LITERAL)
...
class JoinLiteral:
    ...
    class Label(enum.Enum):
        ...
        SEPARATOR = enum.auto()
    span: fltk.fegen.pyrt.terminalsrc.Span = fltk.fegen.pyrt.terminalsrc.UnknownSpan
    children: list[tuple[typing.Optional[Label], typing.Union['DocListLiteral', 'DocLiteral', 'Trivia']]] = dataclasses.field(default_factory=list)

    def append(self, child: typing.Union['DocListLiteral', 'DocLiteral', 'Trivia'], label: typing.Optional[Label]=None) -> None:
        self.children.append((label, child))

    def extend(self, children: typing.Iterable[typing.Union['DocListLiteral', 'DocLiteral', 'Trivia']], label: typing.Optional[Label]=None) -> None:
        self.children.extend(((label, child) for child in children))

    def child(self) -> tuple[typing.Optional[Label], typing.Union['DocListLiteral', 'DocLiteral', 'Trivia']]:
        if (n := len(self.children)) != 1:
            msg = f'Expected one child but have {n}'
            raise ValueError(msg)
        return self.children[0]
    ...
    def children_doc_list_literal(self) -> typing.Iterator['DocListLiteral']:
        return (typing.cast('DocListLiteral', child) for label, child in self.children if label == JoinLiteral.Label.DOC_LIST_LITERAL)
    ...
    def children_separator(self) -> typing.Iterator['DocLiteral']:
        return (typing.cast('DocLiteral', child) for label, child in self.children if label == JoinLiteral.Label.SEPARATOR)
...
class DocListLiteral:
    ...
    class Label(enum.Enum):
        DOC_LITERAL = enum.auto()
    span: fltk.fegen.pyrt.terminalsrc.Span = fltk.fegen.pyrt.terminalsrc.UnknownSpan
    children: list[tuple[typing.Optional[Label], typing.Union['DocLiteral', 'Trivia']]] = dataclasses.field(default_factory=list)

    def append(self, child: typing.Union['DocLiteral', 'Trivia'], label: typing.Optional[Label]=None) -> None:
        self.children.append((label, child))

    def extend(self, children: typing.Iterable[typing.Union['DocLiteral', 'Trivia']], label: typing.Optional[Label]=None) -> None:
        self.children.extend(((label, child) for child in children))

    def child(self) -> tuple[typing.Optional[Label], typing.Union['DocLiteral', 'Trivia']]:
        if (n := len(self.children)) != 1:
            msg = f'Expected one child but have {n}'
            raise ValueError(msg)
        return self.children[0]
    ...
    def children_doc_literal(self) -> typing.Iterator['DocLiteral']:
        return (typing.cast('DocLiteral', child) for label, child in self.children if label == DocListLiteral.Label.DOC_LITERAL)
...
class CompoundLiteral:
    ...
    class Label(enum.Enum):
        ...
        NEST = enum.auto()
    span: fltk.fegen.pyrt.terminalsrc.Span = fltk.fegen.pyrt.terminalsrc.UnknownSpan
    children: list[tuple[typing.Optional[Label], typing.Union['DocLiteral', 'Trivia', 'fltk.fegen.pyrt.terminalsrc.Span']]] = dataclasses.field(default_factory=list)

    def append(self, child: typing.Union['DocLiteral', 'Trivia', 'fltk.fegen.pyrt.terminalsrc.Span'], label: typing.Optional[Label]=None) -> None:
        self.children.append((label, child))

    def extend(self, children: typing.Iterable[typing.Union['DocLiteral', 'Trivia', 'fltk.fegen.pyrt.terminalsrc.Span']], label: typing.Optional[Label]=None) -> None:
        self.children.extend(((label, child) for child in children))

    def child(self) -> tuple[typing.Optional[Label], typing.Union['DocLiteral', 'Trivia', 'fltk.fegen.pyrt.terminalsrc.Span']]:
        if (n := len(self.children)) != 1:
            msg = f'Expected one child but have {n}'
            raise ValueError(msg)
        return self.children[0]
    ...
    def children_doc_literal(self) -> typing.Iterator['DocLiteral']:
        return (typing.cast('DocLiteral', child) for label, child in self.children if label == CompoundLiteral.Label.DOC_LITERAL)
    ...
    def children_group(self) -> typing.Iterator['fltk.fegen.pyrt.terminalsrc.Span']:
        return (typing.cast('fltk.fegen.pyrt.terminalsrc.Span', child) for label, child in self.children if label == CompoundLiteral.Label.GROUP)
    ...
    def children_nest(self) -> typing.Iterator['fltk.fegen.pyrt.terminalsrc.Span']:
        return (typing.cast('fltk.fegen.pyrt.terminalsrc.Span', child) for label, child in self.children if label == CompoundLiteral.Label.NEST)
...
class TriviaPreserve:
    ...
    span: fltk.fegen.pyrt.terminalsrc.Span = fltk.fegen.pyrt.terminalsrc.UnknownSpan
    children: list[tuple[typing.Optional[Label], typing.Union['Trivia', 'TriviaNodeList']]] = dataclasses.field(default_factory=list)

    def append(self, child: typing.Union['Trivia', 'TriviaNodeList'], label: typing.Optional[Label]=None) -> None:
        self.children.append((label, child))

    def extend(self, children: typing.Iterable[typing.Union['Trivia', 'TriviaNodeList']], label: typing.Optional[Label]=None) -> None:
        self.children.extend(((label, child) for child in children))

    def child(self) -> tuple[typing.Optional[Label], typing.Union['Trivia', 'TriviaNodeList']]:
        if (n := len(self.children)) != 1:
            msg = f'Expected one child but have {n}'
            raise ValueError(msg)
        return self.children[0]
    ...
    def children_trivia_node_list(self) -> typing.Iterator['TriviaNodeList']:
        return (typing.cast('TriviaNodeList', child) for label, child in self.children if label == TriviaPreserve.Label.TRIVIA_NODE_LIST)
...
class TriviaNodeList:
    ...
    span: fltk.fegen.pyrt.terminalsrc.Span = fltk.fegen.pyrt.terminalsrc.UnknownSpan
    children: list[tuple[typing.Optional[Label], typing.Union['Identifier', 'Trivia']]] = dataclasses.field(default_factory=list)

    def append(self, child: typing.Union['Identifier', 'Trivia'], label: typing.Optional[Label]=None) -> None:
        self.children.append((label, child))

    def extend(self, children: typing.Iterable[typing.Union['Identifier', 'Trivia']], label: typing.Optional[Label]=None) -> None:
        self.children.extend(((label, child) for child in children))

    def child(self) -> tuple[typing.Optional[Label], typing.Union['Identifier', 'Trivia']]:
        if (n := len(self.children)) != 1:
            msg = f'Expected one child but have {n}'
            raise ValueError(msg)
        return self.children[0]
    ...
    def children_identifier(self) -> typing.Iterator['Identifier']:
        return (typing.cast('Identifier', child) for label, child in self.children if label == TriviaNodeList.Label.IDENTIFIER)
...
class PreserveBlanks:
    ...
    class Label(enum.Enum):
        COUNT = enum.auto()
    span: fltk.fegen.pyrt.terminalsrc.Span = fltk.fegen.pyrt.terminalsrc.UnknownSpan
    children: list[tuple[typing.Optional[Label], typing.Union['Integer', 'Trivia']]] = dataclasses.field(default_factory=list)

    def append(self, child: typing.Union['Integer', 'Trivia'], label: typing.Optional[Label]=None) -> None:
        self.children.append((label, child))

    def extend(self, children: typing.Iterable[typing.Union['Integer', 'Trivia']], label: typing.Optional[Label]=None) -> None:
        self.children.extend(((label, child) for child in children))

    def child(self) -> tuple[typing.Optional[Label], typing.Union['Integer', 'Trivia']]:
        if (n := len(self.children)) != 1:
            msg = f'Expected one child but have {n}'
            raise ValueError(msg)
        return self.children[0]
    ...
    def children_count(self) -> typing.Iterator['Integer']:
        return (typing.cast('Integer', child) for label, child in self.children if label == PreserveBlanks.Label.COUNT)
...
class Trivia:
    ...
    span: fltk.fegen.pyrt.terminalsrc.Span = fltk.fegen.pyrt.terminalsrc.UnknownSpan
    children: list[tuple[typing.Optional[Label], typing.Union['LineComment', 'fltk.fegen.pyrt.terminalsrc.Span']]] = dataclasses.field(default_factory=list)

    def append(self, child: typing.Union['LineComment', 'fltk.fegen.pyrt.terminalsrc.Span'], label: typing.Optional[Label]=None) -> None:
        self.children.append((label, child))

    def extend(self, children: typing.Iterable[typing.Union['LineComment', 'fltk.fegen.pyrt.terminalsrc.Span']], label: typing.Optional[Label]=None) -> None:
        self.children.extend(((label, child) for child in children))

    def child(self) -> tuple[typing.Optional[Label], typing.Union['LineComment', 'fltk.fegen.pyrt.terminalsrc.Span']]:
        if (n := len(self.children)) != 1:
            msg = f'Expected one child but have {n}'
            raise ValueError(msg)
        return self.children[0]
    ...
    def children_line_comment(self) -> typing.Iterator['LineComment']:
        return (typing.cast('LineComment', child) for label, child in self.children if label == Trivia.Label.LINE_COMMENT)
