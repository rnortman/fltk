...
class Expr:
    ...
    children: list[tuple[Label | None, typing.Union["Term", "Trivia", "fltk.fegen.pyrt.span.Span"]]] = (
        dataclasses.field(default_factory=list)
    )

    def append(
        self, child: typing.Union["Term", "Trivia", "fltk.fegen.pyrt.span.Span"], label: Label | None = None
    ) -> None:
        self.children.append((label, child))

    def extend(
        self,
        children: typing.Iterable[typing.Union["Term", "Trivia", "fltk.fegen.pyrt.span.Span"]],
    ...
    def child(self) -> tuple[Label | None, typing.Union["Term", "Trivia", "fltk.fegen.pyrt.span.Span"]]:
    ...
    def maybe_plus(self) -> typing.Optional["fltk.fegen.pyrt.span.Span"]:
        children = list(self.children_plus())
        if (n := len(children)) > 1:
...
class Term:
    ...
    span: fltk.fegen.pyrt.terminalsrc.Span = fltk.fegen.pyrt.terminalsrc.UnknownSpan
    children: list[tuple[Label | None, typing.Union["Factor", "Trivia", "fltk.fegen.pyrt.span.Span"]]] = (
        dataclasses.field(default_factory=list)
    )

    def append(
        self, child: typing.Union["Factor", "Trivia", "fltk.fegen.pyrt.span.Span"], label: Label | None = None
    ) -> None:
        self.children.append((label, child))

    def extend(
        self,
        children: typing.Iterable[typing.Union["Factor", "Trivia", "fltk.fegen.pyrt.span.Span"]],
        label: Label | None = None,
    ) -> None:
        self.children.extend((label, child) for child in children)
    ...
    def child(self) -> tuple[Label | None, typing.Union["Factor", "Trivia", "fltk.fegen.pyrt.span.Span"]]:
        if (n := len(self.children)) != 1:
            msg = f"Expected one child but have {n}"
            raise ValueError(msg)
        return self.children[0]
    ...
    def maybe_mult(self) -> typing.Optional["fltk.fegen.pyrt.span.Span"]:
        children = list(self.children_mult())
        if (n := len(children)) > 1:
